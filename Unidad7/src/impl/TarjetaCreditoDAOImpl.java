...
public class TarjetaCreditoDAOImpl implements TarjetaCreditoDAO {
    ...
    private final String SELECT_ALL = "SELECT * FROM tarjetas_credito";
    private final String SELECT_ONE = "SELECT * FROM tarjetas_credito WHERE id = ?";


    public TarjetaCreditoDAOImpl(Connection connection) {
